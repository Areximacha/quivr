!function(a) {
    ...
    a.Parse = a.Parse || {};
    var b = a.Parse;
    "undefined" != typeof localStorage ? b.localStorage = localStorage : "undefined" != typeof require && (b.localStorage = require("localStorage")), 
    "undefined" != typeof XMLHttpRequest ? b.XMLHttpRequest = XMLHttpRequest : "undefined" != typeof require && (b.XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest), 
    ...
    var c = function() {}, d = function(a, d, e) {
        ...
        }, b._.extend(f, a), c.prototype = a.prototype, f.prototype = new c(), d && b._.extend(f.prototype, d), 
    ...
    b.initialize = function(a, c, d) {
        ...
        if (b._installationId = b.localStorage.getItem(a), !b._installationId || "" === b._installationId) {
            ...
            b.localStorage.setItem(a, b._installationId);
        }
        ...
        }, j.open(a, c, !0), j.setRequestHeader("Content-Type", "text/plain"), b._isNode && j.setRequestHeader("User-Agent", "Parse/" + b.VERSION + " (NodeJS " + process.versions.node + ")"), 
        j.send(d), h._thenRunCallbacks(g);
        ...
        var k = b.serverURL;
        "/" !== k.charAt(k.length - 1) && (k += "/"), k += "1/" + c, d && (k += "/" + d), 
        e && (k += "/" + e), i = b._.clone(i || {}), "POST" !== f && (i._method = f, f = "POST"), 
        ...
        i._InstallationId = b._getInstallationId(), h && (i._SessionToken = h);
    ...
    b.Events = {
        ...
        off: function(a, b, d) {
            ...
            if (f = this._callbacks) {
                ...
                for (a = a ? a.split(c) : _.keys(f), e = a.shift(); e; ) if (g = f[e], delete f[e], 
                g && (b || d)) {
    ...
    b.Object = function(a, d) {
        ...
        set: function(a, d, e) {
            ...
            return b._arrayEach(c.keys(f), function(a) {
                ...
                var g = !0;
                d instanceof b.Op.Set && c.isEqual(h.attributes[a], d.value) && (g = !1), g && (delete i[a], 
                e.silent ? h._silent[a] = !0 : e.changes[a] = !0);
                var j = c.last(h._opSetQueue);
                j[a] = d._mergeWithPrevious(j[a]), h._rebuildEstimatedDataForKey(a), g ? (h.changed[a] = h.attributes[a], 
                e.silent || (h._pending[a] = !0)) : (delete h.changed[a], delete h._pending[a]);
        ...
        parse: function(a, d) {
            ...
            }), e.updatedAt || (e.updatedAt = e.createdAt), d && (this._existed = 201 !== d), 
            e;
        },
        clone: function() {
    ...
    b.User = b.Object.extend("_User", {
        ...
        logOut: function() {
            null !== b.User._currentUser && (b.User._currentUser._logOutWithAll(), b.User._currentUser._isCurrentUser = !1), 
            b.User._currentUserMatchesDisk = !0, b.User._currentUser = null, b.localStorage.removeItem(b._getParsePath(b.User._CURRENT_USER_KEY));
        },
        ...
        _saveCurrentUser: function(a) {
            b.User._currentUser !== a && b.User.logOut(), a._isCurrentUser = !0, b.User._currentUser = a, 
            b.User._currentUserMatchesDisk = !0;
            var c = a.toJSON();
